        ...
        <Layout style={{ minHeight: '100vh' }}>
            <Sider trigger={null} collapsible collapsed={collapsed} onCollapse={value => setCollapsed(value)} breakpoint={"lg"}>
                ...
                <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
                    ...
                    <SubMenu title={<span><TagOutlined/><span>Products</span></span>}>
                    ...
                    <SubMenu title={<span><FileTextOutlined/><span>CMS </span></span>}>
                    </SubMenu>     
                    <SubMenu title={<span><NotificationOutlined/><span>Marketing</span></span>}>
                    </SubMenu>     
